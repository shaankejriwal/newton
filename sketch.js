...
function setup() {
	...
	rope1 = new Rope(ball1.body,{x:480, y:200});
	rope2 = new Rope(ball2.body,{x:510, y:200});
	rope3 = new Rope(ball3.body,{x:540, y:200});
	rope4 = new Rope(ball4.body,{x:570, y:200});
	rope5 = new Rope(ball5.body,{x:600, y:200});
	rope6 = new Rope(ball6.body,{x:630, y:200});
	rope7 = new Rope(ball7.body,{x:660, y:200});
	rope8 = new Rope(ball8.body,{x:690, y:200});
	rope9 = new Rope(ball9.body,{x:720, y:200});
